<html>
    ...
    border-width: 1px; overflow: scroll;" class=" row pdfcontainer">
           <?php     $subtotal=0;
                                    $total=0;
                                    $product=array();
...
<?php if($product[0]['partnericon']){
    ?>
             <ul  style="padding-left:0px; margin-left: -600px;" >
                <img  style="width:75px; margin-left:49%;" title="" alt="" src="<?php echo base_url();?>partnericons/<?php echo $product[0]['partnericon']; ?>">
