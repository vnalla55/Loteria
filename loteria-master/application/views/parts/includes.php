<meta content="text/html; charset=utf-8" http-equiv="Content-Type">
    ...
    <script src="<?php echo base_url(); ?>resource/newthemebootstrap/dist/js/pages/dashboard.js" type="text/javascript"></script>

    <!-- AdminLTE for demo purposes -->
    <script src="<?php echo base_url(); ?>resource/newthemebootstrap/dist/js/demo.js" type="text/javascript"></script>
