            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       ...
                       <?php echo lang('lang_bet_disapproval_sucess_email_content1');?> {email_lotto_group_name} 
                       <?php echo lang('lang_bet_disapproval_sucess_email_content2');?>  {email_lottery_game_name}
                        <?php echo lang('lang_bet_disapproval_sucess_email_content3');?> :{email_bet_numbers} 
                         <?php echo lang('lang_bet_disapproval_sucess_email_content4');?>
