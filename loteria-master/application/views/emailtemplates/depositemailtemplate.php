            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       <?php echo lang('lang_email_salutation');?> {email_username} !!!  {email_system_admin_name} <br>
                       <?php echo lang('lang_deposit_sucess_email_content1');?> {email_deposit_amount} 
                       <?php echo lang('lang_deposit_sucess_email_content2');?>  
