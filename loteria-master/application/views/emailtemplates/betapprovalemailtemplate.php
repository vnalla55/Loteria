            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       <?php echo lang('lang_email_salutation');?> {email_username} !!!<br>
                       <?php echo lang('lang_bet_approval_sucess_email_content1');?> {email_lotto_group_name} 
                       <?php echo lang('lang_bet_approval_sucess_email_content2');?>  {email_lottery_game_name}
                        <?php echo lang('lang_bet_approval_sucess_email_content3');?> :{email_bet_numbers} 
                         <?php echo lang('lang_bet_approval_sucess_email_content4');?> 
                         <?php echo lang('lang_bet_approval_sucess_email_content5');?> :{email_ticket_number} 
                         <?php echo lang('lang_bet_approval_sucess_email_content6');?>
