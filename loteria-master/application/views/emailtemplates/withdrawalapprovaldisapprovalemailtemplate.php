            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       ...
                       <?php echo lang('lang_withdrawal_approval_disapproval_email_content1');?> {email_withdrawal_date} 
                       <?php echo lang('lang_withdrawal_approval_disapproval_email_content2');?>  {email_withdrawal_amount}
                         <?php echo lang('lang_withdrawal_approval_disapproval_email_content3');?>  {email_approved_or_disapproved_message}
