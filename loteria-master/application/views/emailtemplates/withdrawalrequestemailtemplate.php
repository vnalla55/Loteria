            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       <?php echo lang('lang_email_salutation');?> {email_admin_username} !!!  {email_sender_username} <br>
                       <?php echo lang('lang_withdrawal_request_email_content1');?> {email_withdraw_amount} 
                       <?php echo lang('lang_withdrawal_request_email_content2');?>  {email_withdraw_request_date} 
                       
                       <?php echo lang('lang_withdrawal_request_email_content3');?>
