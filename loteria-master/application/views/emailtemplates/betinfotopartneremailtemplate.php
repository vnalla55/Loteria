            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       <?php echo lang('lang_email_salutation');?> {email_partner_username} !!!   <br>
                       <?php echo lang('lang_partner_bet_info_email_content1');?> {email_customer_username} 
                       <?php echo lang('lang_partner_bet_info_email_content2');?>  {email_bet_amount} 
                       
                       <?php echo lang('lang_partner_bet_info_email_content3');?>
