            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                      {email_username},    <br>
                       <?php echo lang('lang_user_registration_success_email_content1');?> <br>
                       <?php echo lang('lang_user_registration_success_email_content2');?>  <br>
                       
                       <?php echo lang('lang_user_registration_success_email_content3');?><br>
                   <?php echo lang('lang_user_registration_success_email_content4');?>{email_username}<br>
                    <?php echo lang('lang_user_registration_success_email_content5');?>{email_password}<br>
                     <?php echo lang('lang_user_registration_success_email_content6');?>
