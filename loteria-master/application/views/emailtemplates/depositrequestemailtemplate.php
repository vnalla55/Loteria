            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body" style="text-align:center">
                       ...
                       <?php echo lang('lang_deposit_request_email_content1');?> {email_deposit_amount} 
                       <?php echo lang('lang_deposit_request_email_content2');?>  {email_deposit_request_date} 
                       
                       <?php echo lang('lang_deposit_request_email_content3');?>
